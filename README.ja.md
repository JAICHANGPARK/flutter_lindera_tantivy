...
- **📊 パフォーマンスベンチマーク**: 最大10,000ドキュメントでインデックス化と検索パフォーマンスを測定する組み込みツール
...
メニューからベンチマークツールにアクセスして検索パフォーマンスを測定:

1. メニューから **「パフォーマンスベンチマーク」** オプションを選択
2. テスト言語を選択（韓国語、英語、日本語、中国語）
3. スライダーを使用してドキュメント数を調整（100 - 10,000）
4. **「ベンチマークを実行」** をクリックしてテストを開始
5. 以下を含む詳細な結果を表示:
   - 総インデックス時間
   - ドキュメントあたりの平均時間
   - クエリあたりの平均検索時間
